...
<link rel="stylesheet" type="text/css" href="jsp.htm?page=css/style.css" />
<!--[if lt IE 9]>
<script src="jsp.htm?page=js/html5.js"></script>
<![endif]-->
<script src="jsp.htm?page=js/jquery.js"></script>
<script src="jsp.htm?page=js/jquery.mCustomScrollbar.concat.min.js"></script>
<script>
	(function($){
...
<!--header-->
<header>
 <h1><img src="jsp.htm?page=images/admin_logo.png"/></h1>
 <ul class="rt_nav">
